...
k3 = (float('33.57')*float(bd['tickers'][a2]['last']))
...
print ('VOL BTC :'+'{:10,.2f}'.format(float((bd ['tickers'][a1]['vol_btc'])))+' ==>     18.84')
print ('VOL ETH :'+'{:10,.2f}'.format(float((bd ['tickers'][a6]['vol_eth'])))+' ==>    148.50')
print ('VOL BTC :'+'{:10,.2f}'.format(float(vol1))+' ==>  7,953.09')
print ('VOL ETH :'+'{:10,.2f}'.format(float(vol2))+' ==> 11,262.34')
