...
print ('VOL BTC :'+'{:10,.2f}'.format(float((bd ['tickers'][a1]['vol_btc'])))+' ==>     27.77')
print ('VOL ETH :'+'{:10,.2f}'.format(float((bd ['tickers'][a6]['vol_eth'])))+' ==>    302.37')
print ('VOL BTC :'+'{:10,.2f}'.format(float(vol1))+' ==>  8,972.97')
print ('VOL ETH :'+'{:10,.2f}'.format(float(vol2))+' ==> 12,223.91')
