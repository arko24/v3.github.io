...
print ('VOL BTC :'+'{:10,.2f}'.format(float((bd ['tickers'][a1]['vol_btc'])))+' ==>     20.70')
print ('VOL ETH :'+'{:10,.2f}'.format(float((bd ['tickers'][a6]['vol_eth'])))+' ==>    200.79')
print ('VOL BTC :'+'{:10,.2f}'.format(float(vol1))+' ==>  7,976.62')
print ('VOL ETH :'+'{:10,.2f}'.format(float(vol2))+' ==> 11,873.74')
